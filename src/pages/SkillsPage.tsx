...
const SKILL_CATEGORIES: SkillCategory[] = [
  ...
  },
  {
    id: 'coursework',
    name: 'Coursework',
    skills: ['Software Engineering', 'Algorithms', 'Databases', 'Operating Systems', 'Systems Programming', 'Artificial Intelligence', 'Object-Oriented Design'],
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default function SkillsPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0a0a0a]">
      ...
      {selectedCategory && (
        <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-white/10 bg-[#0a0a0a]/95 p-6 backdrop-blur-xl lg:absolute lg:bottom-8 lg:left-1/2 lg:right-auto lg:w-full lg:max-w-lg lg:-translate-x-1/2 lg:rounded-2xl lg:border">
